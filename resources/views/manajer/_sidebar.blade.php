...
<li>
    <a href="{{ route('manajer.receipts.index') }}" class="sidebar-link {{ request()->routeIs('manajer.receipts.*') ? 'active' : '' }}">
        <svg class="w-5 h-5 mr-3 sidebar-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7 3h10a2 2 0 012 2v14l-4-2-4 2-4-2-4 2V5a2 2 0 012-2h2"/></svg>
        <span class="sidebar-text">Validasi Nota / LPJ</span>
    </a>
</li>
<li>
