...
<li>
    <a href="{{ route('rab.index') }}" class="sidebar-link {{ request()->routeIs('rab.*') ? 'active' : '' }}">
        ...
        <span class="sidebar-text">Manajemen RAB</span>
    </a>
</li>
<li>
    <a href="{{ route('admin.input-nota.index') }}" class="sidebar-link {{ request()->routeIs('admin.input-nota.*') ? 'active' : '' }}">
        ...
        <span class="sidebar-text">Input Nota / LPJ</span>
    </a>
</li>
